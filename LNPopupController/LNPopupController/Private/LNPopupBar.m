...
- (void)setCustomBarViewController:(LNPopupCustomBarViewController*)customBarViewController
{
    if(_customBarViewController != customBarViewController)
        ...
        if ([self respondsToSelector:@selector(topAnchor)]){
            ...
            id views = @{
                         @"subView" : _customBarViewController.view,
                         };
            
            
            NSArray <NSLayoutConstraint *> *hLayoutConstraint = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|[subView]|"
                                                                                                        options:0
                                                                                                        metrics:nil
                                                                                                          views:views];
            
            NSArray <NSLayoutConstraint *> *vLayoutConstraint = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|[subView]|"
                                                                                                        options:0
                                                                                                        metrics:nil
                                                                                                          views:views];
            
            [NSLayoutConstraint activateConstraints:hLayoutConstraint];
            [NSLayoutConstraint activateConstraints:vLayoutConstraint];
