...
/** The length of delay in seconds that the label pauses before starting a scroll. */
@property (nonatomic, assign) IBInspectable CGFloat animationDelayBefore;
/** The length of delay in seconds that the label pauses at the completion of a scroll. */
@property (nonatomic, assign) IBInspectable CGFloat animationDelayAfter;
